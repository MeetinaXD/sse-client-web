            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        (_b = (_c = this.retries)[url]) !== null && _b !== void 0 ? _b : (_c[url] = 0);
                        this.retries[url] += 1;
                        if (this.retryConfig.retries && this.retries[url] >= this.retryConfig.retries) {
                            ...
                            this.unregister(url);
                            return [2 /*return*/, Promise.reject(new Error("[SSEClient] Too many retry, this url is no longer subscribed: ".concat(this.baseURL).concat(url)))];
                        }
